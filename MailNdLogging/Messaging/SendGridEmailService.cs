...
namespace MailNdLogging.Messaging
{
    public class SendGridEmailService
    {
        ...
        public SendGridEmailService(string apiKey, string senderEmail = "Test@cyberacademy.com",string senderName = "Cyber Academy[emChristos]")
        {
